  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex flex-col sm:flex-row gap-3 items-start sm:items-center justify-between">
        ...
        <Button onClick={openAdd} className="bg-primary hover:bg-primary/90 text-primary-foreground gap-2 w-full sm:w-auto">
          <UserPlus size={16} />
          Add Customer
        </Button>
      </div>
                      ...
                      <td className="text-right">
                        <div className="flex items-center justify-end gap-1">
                          ...
                          <button
                            ...
                            className="p-1.5 rounded-lg hover:bg-destructive/5 text-destructive transition-colors"
                            title="Delete"
                          >
                            <Trash2 size={15} />
                          </button>
